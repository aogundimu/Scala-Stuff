object mergesort {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(62); 
  ...
  };System.out.println("""msort: (xs: List[Int])List[Int]""");$skip(37); 
