...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  var remCnt = $uI(remainingCharsCount.apply__O());
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remCnt$1) {
    return (function() {
      switch (remCnt$1) {
        default:
          return ((remCnt$1 >= 15) ? "green" : ((remCnt$1 >= 0) ? "orange" : "red"));
      }
    })
  })(remCnt));
  return new $c_Lcalculator_Signal().init___F0(expr)
